...
<?php
      ...
      // SEND NOTICATION EMAIL TO ADMINS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      function sendContactEmail($recipients, $subject, $commname, $from, $replyToEmail, $page, $firstName, $lastName, $email, $phone, $reason, $method, $text) {
      ...
      function sendContactConfEmail($from, $replyToEmail, $firstName, $lastName, $email, $phone, $text, $commname, $address, $commphone) {
      ...
      function sendRecruitingEmail($reason, $from, $replyToEmail, $commname, $address, $commphone) {
        if ($reason === 'Seeking employment') {
          ...
          $confMessage .= '<h3>If you are ready to apply, please visit our <a href="https://careers-avamere.icims.com/jobs/intro" style="color: #009cdc;">career website.</a></h3><br>';
          $confMessage .= '</body></html>';
      ...
      if ($reason === 'Seeking employment') {
        ...
        sendContactConfEmail($from, $replyToEmail, $firstName, $lastName, $email, $phone, $text, $commname, $address, $commphone);
      }
      ...
      sendContactEmail($recipients, $subject, $commname, $from, $replyToEmail, $page, $firstName, $lastName, $email, $phone, $reason, $method, $text);
